...
resetprop -n ro.vendor.dirac.startAtBoot 3
resetprop -n ro.vendor.dirac.acs.startAtBoot 3
resetprop -n ro.vendor.dirac.acs.forceAfm true
resetprop -n ro.vendor.dirac.acs.storeSettings 1
resetprop -n ro.vendor.dirac.acs.ignore_error 1
resetprop -n ro.vendor.dirac.acs.music_stream false
